...
import { findAndCountAnimals } from "../lib/requests/vet-plus/animalsRequests";
...
export default async function Home() {
  ...
  const animalsList = await findAndCountAnimals();

  return (
    <>
      <HeaderPage title="Animals List" icon={PawPrint} />
      <RootPage animals={animalsList.result?.rows} />
    </>
  );
}
